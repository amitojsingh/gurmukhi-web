  ...
  return (
    <div className={commonStyle}>
      <div className='flex justify-center items-center h-full'>
        <div className='my-2'>
          <img className='mx-auto my-2' src='/images/star.webp' alt='Star' width={35} height={32} />
          ...
          {randomWord && (
            <button
              className='font-serif text-xs md:text-sm text-sky-700 underline underline-offset-8'
              onClick={() => {
